...
import PeptideCalculator from "@modules/common/components/peptide-calculator"
import FAQ from "@modules/common/components/faq"

export const metadata: Metadata = {
  title: "Peptide Calculator | Molecule",
  description:
    "Calculate peptide reconstitution concentrations and injection volumes with our easy-to-use peptide calculator tool.",
}
