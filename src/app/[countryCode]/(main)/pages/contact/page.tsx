...
export const metadata: Metadata = {
  title: "Contact Us | Molecule",
  description:
    "Get in touch with Molecule for questions about our research peptides, bulk orders, or customer support.",
}
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            ...
            <div className="p-6 bg-gray-50 rounded-lg">
              ...
              <a
                href="mailto:sales@molecule.com"
                className="text-gray-900 font-medium hover:text-gray-700 underline"
              >
                sales@molecule.com
              </a>
