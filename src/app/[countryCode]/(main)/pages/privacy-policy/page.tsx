...
export const metadata: Metadata = {
  title: "Privacy Policy | Molecule",
  description:
    "Read the Privacy Policy for Molecule - how we collect, use, and protect your personal information.",
}
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              ...
              traffic, and understand where our visitors are coming from. You can control cookie preferences 
          ...
          <section className="mb-12">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mt-4">
              ...
              <a href="mailto:privacy@molecule.com" className="text-gray-900 font-medium hover:text-gray-700 underline">
          ...
          <section className="mb-12">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Our services are not intended for individuals under the age of 21. We do not knowingly collect 
