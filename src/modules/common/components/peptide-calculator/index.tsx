...
export default function PeptideCalculator() {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6 md:p-8 shadow-sm">
        ...
        <button
          onClick={calculate}
          className="w-full py-3 px-6 bg-gray-900 text-white font-semibold rounded-md hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
        >
