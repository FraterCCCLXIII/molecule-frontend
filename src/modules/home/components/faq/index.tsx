...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: (
      <p>
        For bulk inquiries and volume pricing, please <LocalizedClientLink href="/pages/contact" title="Contact" className="underline hover:no-underline">contact us</LocalizedClientLink>.
      </p>
    ),
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="section-stack__intro">
            <div className="flex flex-col gap-10">
              ...
              <div className="hidden lg:block">
                <div className="faq-availability"></div>
              </div>
            </div>
          </div>
          ...
          <div className="section-stack__main">
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="accordion__toggle w-full flex items-center gap-4 py-6 font-semibold text-xl hover:text-gray-700 transition-colors text-left"
            ...
            {/* Availability widget for mobile */}
